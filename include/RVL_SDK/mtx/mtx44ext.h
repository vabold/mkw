...
void PSMTX44MultVecArray( CMtx44Ptr m, CVecPtr srcBase, VecPtr dstBase, u32 count );
...
void PSMTX44MultVecArraySR( CMtx44Ptr m, CVecPtr srcBase, VecPtr dstBase, u32 count );
