...
{
    OSAssertMessage( a, "VECAdd():  NULL VecPtr 'a' " );
    OSAssertMessage( b, "VECAdd():  NULL VecPtr 'b' " );
    OSAssertMessage( ab, "VECAdd():  NULL VecPtr 'ab' " );
...
asm void PSVECAdd( register CVecPtr vec1, register CVecPtr vec2, register VecPtr dst )
{
...
{
    OSAssertMessage( a, "VECSubtract():  NULL VecPtr 'a' " );
    OSAssertMessage( b, "VECSubtract():  NULL VecPtr 'b' " );
    OSAssertMessage( a_b, "VECSubtract():  NULL VecPtr 'a_b' " );
...
asm void PSVECSubtract( register CVecPtr vec1, register CVecPtr vec2, register VecPtr dst )
{
    psq_l f2, Vec.x( vec1 ), 0, qr0;
    psq_l f4, Vec.x( vec2 ), 0, qr0;
    ps_sub f6, f2, f4;
...
{
    OSAssertMessage( src, "VECScale():  NULL VecPtr 'src' " );
    OSAssertMessage( dst, "VECScale():  NULL VecPtr 'dst' " );
...
void C_VECNormalize( CVecPtr src, VecPtr unit )
{
    ...
    OSAssertMessage( src, "VECNormalize():  NULL VecPtr 'src' " );
    OSAssertMessage( unit, "VECNormalize():  NULL VecPtr 'unit' " );

    mag = src->x * src->x + src->y * src->y + src->z * src->z;
    OSAssertMessage( mag != 0.0f, "VECNormalize():  zero magnitude vector " );
...
f32 C_VECSquareMag( CVecPtr v )
{
    ...
    OSAssertMessage( v, "VECMag():  NULL VecPtr 'v' " );
...
f32 C_VECDotProduct( CVecPtr a, CVecPtr b )
{
    ...
    OSAssertMessage( a, "VECDotProduct():  NULL VecPtr 'a' " );
    OSAssertMessage( b, "VECDotProduct():  NULL VecPtr 'b' " );
...
void C_VECCrossProduct( CVecPtr a, CVecPtr b, VecPtr axb )
{
    ...
    OSAssertMessage( a, "VECCrossProduct():  NULL VecPtr 'a' " );
    OSAssertMessage( b, "VECCrossProduct():  NULL VecPtr 'b' " );
    OSAssertMessage( axb, "VECCrossProduct():  NULL VecPtr 'axb' " );
...
asm void PSVECCrossProduct( register CVecPtr vec1, register CVecPtr vec2, register VecPtr dst )
{
...
void C_VECHalfAngle( CVecPtr a, CVecPtr b, VecPtr half )
{
    ...
    OSAssertMessage( a, "VECHalfAngle():  NULL VecPtr 'a' " );
    OSAssertMessage( b, "VECHalfAngle():  NULL VecPtr 'b' " );
    OSAssertMessage( half, "VECHalfAngle():  NULL VecPtr 'half' " );
...
void C_VECReflect( CVecPtr src, CVecPtr normal, VecPtr dst )
{
    ...
    OSAssertMessage( src, "VECReflect():  NULL VecPtr 'src' " );
    OSAssertMessage( normal, "VECReflect():  NULL VecPtr 'normal' " );
    OSAssertMessage( dst, "VECReflect():  NULL VecPtr 'dst' " );
