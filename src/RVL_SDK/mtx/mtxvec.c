...
void C_MTXMultVec( CMtxPtr m, CVecPtr src, VecPtr dst )
{
    ...
    OSAssertMessage( m, "MTXMultVec():  NULL MtxPtr 'm' " );
    OSAssertMessage( src, "MTXMultVec():  NULL VecPtr 'src' " );
    OSAssertMessage( dst, "MTXMultVec():  NULL VecPtr 'dst' " );
...
asm void PSMTXMultVec( register CMtxPtr m, register CVecPtr src, register VecPtr dst )
{
    nofralloc;
...
void C_MTXMultVecArray( CMtxPtr m, CVecPtr srcBase, VecPtr dstBase, u32 count )
{
    ...
    OSAssertMessage( m, "MTXMultVecArray():  NULL MtxPtr 'm' " );
    OSAssertMessage( srcBase, "MTXMultVecArray():  NULL VecPtr 'srcBase' " );
    OSAssertMessage( dstBase, "MTXMultVecArray():  NULL VecPtr 'dstBase' " );
    OSAssertMessage( count > 1, "MTXMultVecArray():  count must be greater than 1." );
...
asm void PSMTXMultVecArray( register CMtxPtr m,
...
void C_MTXMultVecSR( CMtxPtr m, CVecPtr src, VecPtr dst )
{
    ...
    OSAssertMessage( m, "MTXMultVecSR():  NULL MtxPtr 'm' " );
    OSAssertMessage( src, "MTXMultVecSR():  NULL VecPtr 'src' " );
    OSAssertMessage( dst, "MTXMultVecSR():  NULL VecPtr 'dst' " );
...
asm void PSMTXMultVecSR( register CMtxPtr m, register CVecPtr src, register VecPtr dst )
{
    nofralloc;
...
void C_MTXMultVecArraySR( CMtxPtr m, CVecPtr srcBase, VecPtr dstBase, u32 count )
{
    ...
    OSAssertMessage( m, "MTXMultVecArraySR():  NULL MtxPtr 'm' " );
    OSAssertMessage( srcBase, "MTXMultVecArraySR():  NULL VecPtr 'srcBase' " );
    OSAssertMessage( dstBase, "MTXMultVecArraySR():  NULL VecPtr 'dstBase' " );
    OSAssertMessage( count > 1, "MTXMultVecArraySR():  count must be greater than 1." );
...
asm void PSMTXMultVecArraySR( register CMtxPtr m,
        register CVecPtr srcBase,
        register VecPtr dstBase,
        register u32 count )
{
