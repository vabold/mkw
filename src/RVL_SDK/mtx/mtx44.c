...
#include <RVL_SDK/mtx/internal/mtx44extAssert.h>
...
void C_MTXFrustum( Mtx44Ptr m, f32 t, f32 b, f32 l, f32 r, f32 n, f32 f )
{
    ...
    OSAssertMessage( m, "MTXFrustum():  NULL Mtx44Ptr 'm' " );
    OSAssertMessage( t != b, "MTXFrustum():  't' and 'b' clipping planes are equal " );
    OSAssertMessage( l != r, "MTXFrustum():  'l' and 'r' clipping planes are equal " );
    OSAssertMessage( n != f, "MTXFrustum():  'n' and 'f' clipping planes are equal " );
...
void C_MTXPerspective( Mtx44Ptr m, f32 fovY, f32 aspect, f32 n, f32 f )
{
    ...
    OSAssertMessage( m, "MTXPerspective():  NULL Mtx44Ptr 'm' " );
    OSAssertMessage( fovY > 0.0 && fovY < 180.0, "MTXPerspective():  'fovY' out of range " );
    OSAssertMessage( aspect != 0.0f, "MTXPerspective():  'aspect' is 0 " );
...
void C_MTXOrtho( Mtx44Ptr m, f32 t, f32 b, f32 l, f32 r, f32 n, f32 f )
{
    ...
    OSAssertMessage( m, "MTXOrtho():  NULL Mtx44Ptr 'm' " );
    OSAssertMessage( t != b, "MTXOrtho():  't' and 'b' clipping planes are equal " );
    OSAssertMessage( l != r, "MTXOrtho():  'l' and 'r' clipping planes are equal " );
    OSAssertMessage( n != f, "MTXOrtho():  'n' and 'f' clipping planes are equal " );
...
{
    OSAssertMessage( m, "MTX44Identity():  NULL Mtx44 'm' " );
...
{
    OSAssertMessage( src, "MTX44Copy():  NULL Mtx44Ptr 'src' " );
    OSAssertMessage( dst, "MTX44Copy():  NULL Mtx44Ptr 'dst' " );
...
void C_MTX44Concat( CMtx44Ptr a, CMtx44Ptr b, Mtx44Ptr ab )
{
    ...
    OSAssertMessage( a, "MTX44Concat():  NULL Mtx44Ptr 'a'  " );
    OSAssertMessage( b, "MTX44Concat():  NULL Mtx44Ptr 'b'  " );
    OSAssertMessage( ab, "MTX44Concat():  NULL Mtx44Ptr 'ab' " );
...
asm void PSMTX44Concat( register CMtx44Ptr mA, register CMtx44Ptr mB, register Mtx44Ptr mAB )
{
    nofralloc;
...
void C_MTX44Transpose( CMtx44Ptr src, Mtx44Ptr xPose )
{
    ...
    OSAssertMessage( src, "MTX44Transpose():  NULL Mtx44Ptr 'src' " );
    OSAssertMessage( xPose, "MTX44Transpose():  NULL Mtx44Ptr 'xPose' " );
...
u32 C_MTX44Inverse( CMtx44Ptr src, Mtx44Ptr inv )
{
    ...
    OSAssertMessage( src, "MTX44Inverse():  NULL Mtx44Ptr 'src' " );
    OSAssertMessage( inv, "MTX44Inverse():  NULL Mtx44Ptr 'inv' " );
...
{
    OSAssertMessage( m, "MTX44Trans():  NULL Mtx44Ptr 'm' " );
...
void PSMTX44Trans( register Mtx44Ptr m, register f32 xT, register f32 yT, register f32 zT )
{
...
{
    OSAssertMessage( src, "MTX44TransApply(): NULL Mtx44Ptr 'src' " );
    OSAssertMessage( dst, "MTX44TransApply(): NULL Mtx44Ptr 'src' " );
...
asm void PSMTX44TransApply( register CMtx44Ptr src,
        register Mtx44Ptr dst,
        register f32 xT,
        register f32 yT,
        register f32 zT )
{
...
{
    OSAssertMessage( m, "MTX44Scale():  NULL Mtx44Ptr 'm' " );
...
void PSMTX44Scale( register Mtx44Ptr m, register f32 xS, register f32 yS, register f32 zS )
{
    register f32 c_zero = 0.0f;
    register f32 c_one = 1.0f;
...
{
    OSAssertMessage( src, "MTX44ScaleApply(): NULL Mtx44Ptr 'src' " );
    OSAssertMessage( dst, "MTX44ScaleApply(): NULL Mtx44Ptr 'dst' " );
...
asm void PSMTX44ScaleApply( register CMtx44Ptr src,
        register Mtx44Ptr dst,
        register f32 xS,
        register f32 yS,
        register f32 zS )
...
void C_MTX44RotRad( Mtx44Ptr m, char axis, f32 rad )
{
    ...
    OSAssertMessage( m, "MTX44RotRad():  NULL Mtx44Ptr 'm' " );
...
{
    OSAssertMessage( m, "MTX44RotTrig():  NULL Mtx44Ptr 'm' " );
    ...
    case 'z':
        ...
        break;
    default:
        OSAssertMessage( FALSE, "MTX44RotTrig():  invalid 'axis' value " );
        break;
    }
}

void PSMTX44RotTrig( register MtxPtr m, register char axis, register f32 sinA, register f32 cosA )
{
    register f32 ftmp0;
    register f32 ftmp1;
    register f32 ftmp2;
...
void C_MTX44RotAxisRad( MtxPtr m, CVecPtr axis, f32 rad )
{
    ...
    OSAssertMessage( m, "MTX44RotAxisRad():  NULL Mtx44Ptr 'm' " );
    OSAssertMessage( axis, "MTX44RotAxisRad():  NULL VecPtr 'axis' " );
