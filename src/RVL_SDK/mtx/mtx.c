...
{
    OSAssertMessage( m, "MtxIdentity():  NULL Mtx 'm' " );
...
{
    OSAssertMessage( src, "MTXCopy():  NULL MtxPtr 'src' " );
    OSAssertMessage( dst, "MTXCopy():  NULL MtxPtr 'dst' " );
...
void C_MTXConcat( CMtxPtr a, CMtxPtr b, MtxPtr ab )
{
    ...
    OSAssertMessage( a, "MTXConcat():  NULL MtxPtr 'a'  " );
    OSAssertMessage( b, "MTXConcat():  NULL MtxPtr 'b'  " );
    OSAssertMessage( ab, "MTXConcat():  NULL MtxPtr 'ab' " );
    ...
    m[ 0 ][ 3 ] = a[ 0 ][ 0 ] * b[ 0 ][ 3 ] + a[ 0 ][ 1 ] * b[ 1 ][ 3 ] +
            a[ 0 ][ 2 ] * b[ 2 ][ 3 ] + a[ 0 ][ 3 ];
    m[ 1 ][ 0 ] = a[ 1 ][ 0 ] * b[ 0 ][ 0 ] + a[ 1 ][ 1 ] * b[ 1 ][ 0 ] + a[ 1 ][ 2 ] * b[ 2 ][ 0 ];
    m[ 1 ][ 1 ] = a[ 1 ][ 0 ] * b[ 0 ][ 1 ] + a[ 1 ][ 1 ] * b[ 1 ][ 1 ] + a[ 1 ][ 2 ] * b[ 2 ][ 1 ];
    m[ 1 ][ 2 ] = a[ 1 ][ 0 ] * b[ 0 ][ 2 ] + a[ 1 ][ 1 ] * b[ 1 ][ 2 ] + a[ 1 ][ 2 ] * b[ 2 ][ 2 ];
    m[ 1 ][ 3 ] = a[ 1 ][ 0 ] * b[ 0 ][ 3 ] + a[ 1 ][ 1 ] * b[ 1 ][ 3 ] +
            a[ 1 ][ 2 ] * b[ 2 ][ 3 ] + a[ 1 ][ 3 ];
    m[ 2 ][ 0 ] = a[ 2 ][ 0 ] * b[ 0 ][ 0 ] + a[ 2 ][ 1 ] * b[ 1 ][ 0 ] + a[ 2 ][ 2 ] * b[ 2 ][ 0 ];
    m[ 2 ][ 1 ] = a[ 2 ][ 0 ] * b[ 0 ][ 1 ] + a[ 2 ][ 1 ] * b[ 1 ][ 1 ] + a[ 2 ][ 2 ] * b[ 2 ][ 1 ];
    m[ 2 ][ 2 ] = a[ 2 ][ 0 ] * b[ 0 ][ 2 ] + a[ 2 ][ 1 ] * b[ 1 ][ 2 ] + a[ 2 ][ 2 ] * b[ 2 ][ 2 ];
    m[ 2 ][ 3 ] = a[ 2 ][ 0 ] * b[ 0 ][ 3 ] + a[ 2 ][ 1 ] * b[ 1 ][ 3 ] +
            a[ 2 ][ 2 ] * b[ 2 ][ 3 ] + a[ 2 ][ 3 ];
...
asm void PSMTXConcat( register CMtxPtr mA, register CMtxPtr mB, register MtxPtr mAB )
{
    nofralloc;
...
void C_MTXConcatArray( CMtxPtr a, CMtxPtr srcBase, MtxPtr dstBase, u32 count )
{
    ...
    OSAssertMessage( a, "MTXConcatArray(): NULL MtxPtr 'a' " );
    OSAssertMessage( srcBase, "MTXConcatArray(): NULL MtxPtr 'srcBase' " );
    OSAssertMessage( dstBase, "MTXConcatArray(): NULL MtxPtr 'dstBase' " );
    OSAssertMessage( count > 1, "MTXConcatArray(): count must be greater than 1." );
...
void PSMTXConcatArray( register CMtxPtr a,
        register CMtxPtr srcBase,
        register MtxPtr dstBase,
        register u32 count )
{
    register f32 a00;
    register f32 a02;
...
void C_MTXTranspose( CMtxPtr src, MtxPtr xPose )
{
    ...
    OSAssertMessage( src, "MTXTranspose():  NULL MtxPtr 'src' " );
    OSAssertMessage( xPose, "MTXTranspose():  NULL MtxPtr 'xPose' " );
...
u32 C_MTXInvXpose( CMtxPtr src, MtxPtr invX )
{
    ...
    OSAssertMessage( src, "MTXInverse():  NULL MtxPtr 'src' " );
    OSAssertMessage( inv, "MTXInverse():  NULL MtxPtr 'inv' " );
...
void C_MTXRotRad( MtxPtr m, char axis, f32 rad )
{
    ...
    OSAssertMessage( m, "MTXRotRad():  NULL MtxPtr 'm' " );
...
{
    OSAssertMessage( m, "MTXRotTrig():  NULL MtxPtr 'm' " );
    ...
    case 'Z':
        ...
        break;
    default:
        OSAssertMessage( FALSE, "MTXRotTrig():  invalid 'axis' value " );
        break;
    }
}

void PSMTXRotTrig( register MtxPtr m, register char axis, register f32 sinA, register f32 cosA )
{
    register f32 fc0;
    register f32 fc1;
    register f32 nsinA;
...
void C_MTXRotAxisRad( MtxPtr m, CVecPtr axis, f32 rad )
{
    ...
    OSAssertMessage( m, "MTXRotAxisRad():  NULL MtxPtr 'm' " );
    OSAssertMessage( axis, "MTXRotAxisRad():  NULL VecPtr 'axis' " );
...
static void __PSMTXRotAxisRadInternal( register MtxPtr m,
        register CVecPtr axis,
        register f32 sT,
        register f32 cT )
{
    register f32 tT;
...
{
    OSAssertMessage( m, "MTXTrans():  NULL MtxPtr 'm' " );
...
void PSMTXTrans( register MtxPtr m, register f32 xT, register f32 yT, register f32 zT )
{
...
{
    OSAssertMessage( src, "MTXTransApply(): NULL MtxPtr 'src' " );
    OSAssertMessage( dst, "MTXTransApply(): NULL MtxPtr 'src' " );
...
asm void PSMTXTransApply( register CMtxPtr src,
        register MtxPtr dst,
        register f32 xT,
        register f32 yT,
        register f32 zT )
...
{
    OSAssertMessage( m, "MTXScale():  NULL MtxPtr 'm' " );
...
void PSMTXScale( register MtxPtr m, register f32 xS, register f32 yS, register f32 zS )
{
    register f32 c0 = 0.0f;
...
{
    OSAssertMessage( src, "MTXScaleApply(): NULL MtxPtr 'src' " );
    OSAssertMessage( dst, "MTXScaleApply(): NULL MtxPtr 'dst' " );
...
asm void PSMTXScaleApply( register CMtxPtr src,
        register MtxPtr dst,
        register f32 xS,
        register f32 yS,
        register f32 zS )
...
void C_MTXQuat( MtxPtr m, CQuaternionPtr q )
{
    ...
    OSAssertMessage( m, "MTXQuat():  NULL MtxPtr 'm' " );
    OSAssertMessage( q, "MTXQuat():  NULL QuaternionPtr 'q' " );
    OSAssertMessage( q->x || q->y || q->z || q->w, "MTXQuat():  zero-value quaternion " );
...
void PSMTXReflect( register MtxPtr m, register CVecPtr point, register CVecPtr normal )
{
    register f32 c_one = 1.0f;
    register f32 vn_xy;
    register f32 vn_z1;
...
void C_MTXLookAt( MtxPtr m, CVecPtr camPos, CVecPtr camUp, CPoint3dPtr target )
{
    ...
    OSAssertMessage( m, "MTXLookAt():  NULL MtxPtr 'm' " );
    OSAssertMessage( camPos, "MTXLookAt():  NULL VecPtr 'camPos' " );
    OSAssertMessage( camUp, "MTXLookAt():  NULL VecPtr 'camUp' " );
    OSAssertMessage( target, "MTXLookAt():  NULL Point3dPtr 'target' " );
...
void C_MTXLightFrustum( MtxPtr m,
        f32 t,
        f32 b,
        f32 l,
        f32 r,
        ...
        f32 transT )
{
    ...
    OSAssertMessage( m, "MTXLightFrustum():  NULL MtxPtr 'm' " );
    OSAssertMessage( t != b, "MTXLightFrustum():  't' and 'b' clipping planes are equal " );
    OSAssertMessage( l != r, "MTXLightFrustum():  'l' and 'r' clipping planes are equal " );
...
void C_MTXLightPerspective( MtxPtr m,
        f32 fovY,
        f32 aspect,
        f32 scaleS,
        f32 scaleT,
        ...
        f32 transT )
{
    ...
    OSAssertMessage( m, "MTXLightPerspective():  NULL MtxPtr 'm' " );
        ...
        f32 transT )
{
    ...
    OSAssertMessage( m, "MTXLightOrtho():  NULL MtxPtr 'm' " );
    OSAssertMessage( t != b, "MTXLightOrtho():  't' and 'b' clipping planes are equal " );
    OSAssertMessage( l != r, "MTXLightOrtho():  'l' and 'r' clipping planes are equal " );
