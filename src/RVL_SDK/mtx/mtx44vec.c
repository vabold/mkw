...
void C_MTX44MultVec( CMtx44Ptr m, CVecPtr src, VecPtr dst )
{
    ...
    OSAssertMessage( m, "MTX44MultVec():  NULL Mtx44Ptr 'm' " );
    OSAssertMessage( src, "MTX44MultVec():  NULL VecPtr 'src' " );
    OSAssertMessage( dst, "MTX44MultVec():  NULL VecPtr 'dst' " );
...
asm void PSMTX44MultVec( register CMtx44Ptr m, register CVecPtr src, register VecPtr dst )
{
    nofralloc;
...
void C_MTX44MultVecArray( CMtx44Ptr m, CVecPtr srcBase, VecPtr dstBase, u32 count )
{
    u32 i;
    Vec vTmp;
    f32 w;

    OSAssertMessage( m, "MTX44MultVecArray():  NULL Mtx44Ptr 'm' " );
    OSAssertMessage( srcBase, "MTX44MultVecArray():  NULL VecPtr 'srcBase' " );
    OSAssertMessage( dstBase, "MTX44MultVecArray():  NULL VecPtr 'dstBase' " );
...
asm void PSMTX44MultVecArray( register CMtx44Ptr m,
        register CVecPtr srcBase,
        register VecPtr dstBase,
        register u32 count )
{
    nofralloc;
...
void C_MTX44MultVecSR( CMtx44Ptr m, CVecPtr src, VecPtr dst )
{
    ...
    OSAssertMessage( m, "MTX44MultVecSR():  NULL Mtx44Ptr 'm' " );
    OSAssertMessage( src, "MTX44MultVecSR():  NULL VecPtr 'src' " );
    OSAssertMessage( dst, "MTX44MultVecSR():  NULL VecPtr 'dst' " );
...
asm void PSMTX44MultVecSR( register CMtx44Ptr m, register CVecPtr src, register VecPtr dst )
{
    nofralloc;
...
void C_MTX44MultVecArraySR( CMtx44Ptr m, CVecPtr srcBase, VecPtr dstBase, u32 count )
{
    u32 i;
    Vec vTmp;

    OSAssertMessage( m, "MTX44MultVecArraySR():  NULL Mtx44Ptr 'm' " );
    OSAssertMessage( srcBase, "MTX44MultVecArraySR():  NULL VecPtr 'srcBase' " );
    OSAssertMessage( dstBase, "MTX44MultVecArraySR():  NULL VecPtr 'dstBase' " );
...
asm void PSMTX44MultVecArraySR( register CMtx44Ptr m,
        register CVecPtr srcBase,
        register VecPtr dstBase,
        register u32 count )
{
