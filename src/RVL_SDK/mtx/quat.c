...
{
    OSAssertMessage( p, "QUATAdd():  NULL QuaternionPtr 'p' " );
    OSAssertMessage( q, "QUATAdd():  NULL QuaternionPtr 'q' " );
    OSAssertMessage( r, "QUATAdd():  NULL QuaternionPtr 'r' " );
...
void PSQUATAdd( register CQuaternionPtr p, register CQuaternionPtr q, register QuaternionPtr r )
{
    register f32 tmp0;
    register f32 tmp1;
    register f32 tmp2;
...
{
    OSAssertMessage( p, "QUATSubtract():  NULL QuaternionPtr 'p' " );
    OSAssertMessage( q, "QUATSubtract():  NULL QuaternionPtr 'q' " );
    OSAssertMessage( r, "QUATSubtract():  NULL QuaternionPtr 'r' " );
...
void PSQUATSubtract( register CQuaternionPtr p,
        register CQuaternionPtr q,
...
void C_QUATMultiply( CQuaternionPtr p, CQuaternionPtr q, QuaternionPtr pq )
{
    ...
    OSAssertMessage( p, "QUATMultiply():  NULL QuaternionPtr 'p' " );
    OSAssertMessage( q, "QUATMultiply():  NULL QuaternionPtr 'q' " );
    OSAssertMessage( pq, "QUATMultiply():  NULL QuaternionPtr 'pq' " );
...
void PSQUATMultiply( register CQuaternionPtr p,
        register CQuaternionPtr q,
...
{
    OSAssertMessage( q, "QUATScale():  NULL QuaternionPtr 'q' " );
    OSAssertMessage( r, "QUATScale():  NULL QuaternionPtr 'r' " );
...
void PSQUATScale( register CQuaternionPtr q, register QuaternionPtr r, register f32 mult )
{
    register f32 tmp0;
    register f32 tmp1;
...
{
    OSAssertMessage( p, "QUATDotProduct():  NULL QuaternionPtr 'p' " );
    OSAssertMessage( q, "QUATDotProduct():  NULL QuaternionPtr 'q' " );
...
void C_QUATNormalize( CQuaternionPtr src, QuaternionPtr unit )
{
    ...
    OSAssertMessage( src, "QUATNormalize():  NULL QuaternionPtr 'src' " );
    OSAssertMessage( unit, "QUATNormalize():  NULL QuaternionPtr 'unit' " );

    norm = src->x * src->x + src->y * src->y + src->z * src->z + src->w * src->w;
    if( norm >= EPSILON )
    {
...
void C_QUATInverse( CQuaternionPtr src, QuaternionPtr inv )
{
    ...
    OSAssertMessage( src, "QUATInverse():  NULL QuaternionPtr 'src' " );
    OSAssertMessage( inv, "QUATInverse():  NULL QuaternionPtr 'inv' " );
...
void C_QUATDivide( CQuaternionPtr p, CQuaternionPtr q, QuaternionPtr r )
{
    ...
    OSAssertMessage( p, "QUATDivide():  NULL QuaternionPtr 'p' " );
    OSAssertMessage( q, "QUATDivide():  NULL QuaternionPtr 'q' " );
    OSAssertMessage( r, "QUATDivide():  NULL QuaternionPtr 'r' " );
...
void C_QUATExp( CQuaternionPtr q, QuaternionPtr r )
{
    ...
    OSAssertMessage( q, "QUATExp():  NULL QuaternionPtr 'q' " );
    OSAssertMessage( r, "QUATExp():  NULL QuaternionPtr 'r' " );
    OSAssertMessage( q->w == 0.0f, "QUATExp():  'q' is not a pure quaternion. " );
...
void C_QUATLogN( CQuaternionPtr q, QuaternionPtr r )
{
    ...
    OSAssertMessage( q, "QUATLogN():  NULL QuaternionPtr 'q' " );
    OSAssertMessage( r, "QUATLogN():  NULL QuaternionPtr 'r' " );
...
void C_QUATMakeClosest( CQuaternionPtr q, CQuaternionPtr qto, QuaternionPtr r )
{
    ...
    OSAssertMessage( q, "QUATMakeClosest():  NULL QuaternionPtr 'q' " );
    OSAssertMessage( qto, "QUATMakeClosest():  NULL QuaternionPtr 'qto' " );
    OSAssertMessage( r, "QUATMakeClosest():  NULL QuaternionPtr 'r' " );
...
void C_QUATRotAxisRad( QuaternionPtr r, CVecPtr axis, f32 rad )
{
    ...
    OSAssertMessage( r, "QUATRotAxisRad():  NULL QuaternionPtr 'r' " );
    OSAssertMessage( axis, "QUATRotAxisRad():  NULL VecPtr 'axis' " );
...
void C_QUATMtx( QuaternionPtr r, CMtxPtr m )
{
    ...
    OSAssertMessage( r, "QUATMtx():  NULL QuaternionPtr 'r' " );
    OSAssertMessage( m, "QUATMtx():  NULL MtxPtr 'm' " );
...
{
    OSAssertMessage( p, "QUATLerp():  NULL QuaternionPtr 'p' " );
    OSAssertMessage( q, "QUATLerp():  NULL QuaternionPtr 'q' " );
    OSAssertMessage( r, "QUATLerp():  NULL QuaternionPtr 'r' " );
...
void C_QUATSlerp( CQuaternionPtr p, CQuaternionPtr q, QuaternionPtr r, f32 t )
{
    ...
    OSAssertMessage( p, "QUATSlerp():  NULL QuaternionPtr 'p' " );
    OSAssertMessage( q, "QUATSlerp():  NULL QuaternionPtr 'q' " );
    OSAssertMessage( r, "QUATSlerp():  NULL QuaternionPtr 'r' " );
...
void C_QUATSquad( CQuaternionPtr p,
        CQuaternionPtr a,
        CQuaternionPtr b,
        CQuaternionPtr q,
        QuaternionPtr r,
        f32 t )
{
    ...
    OSAssertMessage( p, "QUATSquad():  NULL QuaternionPtr 'p' " );
    OSAssertMessage( a, "QUATSquad():  NULL QuaternionPtr 'a' " );
    OSAssertMessage( b, "QUATSquad():  NULL QuaternionPtr 'b' " );
    OSAssertMessage( q, "QUATSquad():  NULL QuaternionPtr 'q' " );
    OSAssertMessage( r, "QUATSquad():  NULL QuaternionPtr 'r' " );
...
void C_QUATCompA( CQuaternionPtr qprev, CQuaternionPtr q, CQuaternionPtr qnext, QuaternionPtr a )
{
    Quaternion tmp0;
    Quaternion tmp1;
    Quaternion tmp2;
    ...
    OSAssertMessage( qprev, "QUATCompA():  NULL QuaternionPtr 'qprev' " );
    OSAssertMessage( q, "QUATCompA():  NULL QuaternionPtr 'q' " );
    OSAssertMessage( qnext, "QUATCompA():  NULL QuaternionPtr 'qnext' " );
    OSAssertMessage( a, "QUATCompA():  NULL QuaternionPtr 'a' " );
